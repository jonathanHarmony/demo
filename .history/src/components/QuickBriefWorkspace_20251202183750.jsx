...
const initialSlides = [
    ...
    // Slide 2: Satisfaction Leaderboard
    {
        ...
        elements: [
            ...
            { id: 'chart-rating', type: 'chart', colSpan: 2, chartType: 'bar', data: ratingData, title: 'Average Customer Ratings by Model' },
            { id: 'chart-volume', type: 'chart', colSpan: 1, chartType: 'bar-vertical', data: purchaseVolumeData, title: 'Amazon Purchase Volume (Last Month)' },
            { id: 'card-io3', type: 'card', colSpan: 1, icon: 'star', title: 'iO 3', content: 'Price: ~605 NIS • Reviews: 180 • Sentiment: 92%', footer: 'Leading Value Model' },
            { id: 'card-io5', type: 'card', colSpan: 1, icon: 'star', title: 'iO 5', content: 'Price: ~749 NIS • Reviews: 210 • Sentiment: 93%', footer: 'Top Rated' },
            { id: 'card-io9', type: 'card', colSpan: 1, icon: 'star', title: 'iO 9', content: 'Price: ~1,512 NIS • Reviews: 255 • Sentiment: 59%', footer: 'Premium Tier' }
        ]
    },
