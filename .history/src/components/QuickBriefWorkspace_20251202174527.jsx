                                        ...
                                        <Draggable key={element.id} draggableId={element.id} index={index}>
                                            {(providedDrag, snapshot) => (
                                                <div
                                                    ...
                                                    className={`${element.type === 'heading' ? 'col-span-2' : 'col-span-1 min-h-[300px]'}`}
                                                    style={{
...
const QuickBriefWorkspace = () => {
    ...
    const handleReorderElements = (result) => {
        ...
        // Only allow reordering within the same slide for now (or implement cross-slide if desired)
