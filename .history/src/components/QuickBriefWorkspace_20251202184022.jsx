...
const initialSlides = [
    ...
    // Slide 2: Satisfaction Leaderboard
    {
        ...
        elements: [
            ...
            { id: 'card-io3', type: 'model-card', colSpan: 1, name: 'iO 3', price: '~605 NIS', rating: 4.83, reviews: 180, sentiment: 92 },
            { id: 'card-io5', type: 'model-card', colSpan: 1, name: 'iO 5', price: '~749 NIS', rating: 4.79, reviews: 210, sentiment: 93 },
            { id: 'card-io9', type: 'model-card', colSpan: 1, name: 'iO 9', price: '~1,512 NIS', rating: 4.53, reviews: 255, sentiment: 59 },
            { id: 'card-io10', type: 'model-card', colSpan: 1, name: 'iO 10', price: '~2,017 NIS', rating: 4.36, reviews: 330, sentiment: 78 },
    ...
    // Slide 3: Sentiment Analysis Overview
    {
        ...
        elements: [
            ...
            { id: 'chart-model', type: 'chart', colSpan: 2, chartType: 'stacked-bar', data: sentimentByModel, title: 'Sentiment Distribution by Model' },
            {
                id: 'insight-pos', type: 'card', colSpan: 1, icon: 'check', title: 'Mid-Tier Excellence',
            ...
            {
                id: 'insight-neg', type: 'card', colSpan: 1, icon: 'alert', title: 'Premium Model Debate',
            ...
            {
                id: 'insight-summary', type: 'card', colSpan: 1, icon: 'trending', title: '53% Positive',
                content: 'Overall positive sentiment indicates strong satisfaction with the iO line across all platforms.',
                footer: '1,170 positive comments'
            }
        ]
    },
    // Slide 4: Key Drivers of Satisfaction
    {
        ...
        elements: [
            ...
            { id: 'chart-features', type: 'chart', colSpan: 3, chartType: 'bar-horizontal', data: featureData, title: 'Feature Mention Frequency' },
            { id: 'pos-cleaning', type: 'card', colSpan: 1, icon: 'thumbsup', title: 'Cleaning Performance', content: 'Most mentioned feature with overwhelmingly positive sentiment. "Professional clean at home" is the core strength.', footer: '435 mentions' },
            { id: 'pos-quality', type: 'card', colSpan: 1, icon: 'thumbsup', title: 'Quality Perception', content: 'Mid-tier models (iO 3, iO 5) praised for build quality and premium feel at reasonable prices.', footer: 'Positive driver' },
            { id: 'pos-edge', type: 'card', colSpan: 1, icon: 'thumbsup', title: 'Competitive Edge', content: 'Users report noticeable upgrade vs. older Oral-B models and Philips Sonicare competitors.', footer: 'Positive driver' },
            { id: 'neg-price', type: 'card', colSpan: 1, icon: 'thumbsdown', title: 'Price Concerns', content: 'Premium models face skepticism about incremental value.', footer: '285 mentions' },
            { id: 'neg-reliability', type: 'card', colSpan: 1, icon: 'thumbsdown', title: 'Reliability Issues', content: 'Charging failures and durability concerns, particularly for high-end models.', footer: '180 mentions' },
            { id: 'neg-heads', type: 'card', colSpan: 1, icon: 'thumbsdown', title: 'Brush Head Design', content: 'Concerns about moisture accumulation and mold formation inside heads.', footer: '270 mentions' }
        ]
    },
    // Slide 5: Feature Deep Dive
    {
        ...
        elements: [
            ...
            { id: 'feat-cleaning', type: 'card', colSpan: 1, icon: 'check', title: 'Cleaning Performance', content: 'Undisputed core strength. "Professional clean at home."\n\nAction: Lead all marketing with this', footer: '435 mentions • EXCELLENT' },
            { id: 'feat-heads', type: 'card', colSpan: 1, icon: 'alert', title: 'Brush Head Design', content: 'Mold formation concerns - critical hygiene issue.\n\nAction: URGENT - Audit design & communicate fixes', footer: '270 mentions • CRITICAL' },
            { id: 'feat-price', type: 'card', colSpan: 1, icon: 'info', title: 'Price & Value', content: 'Premium models questioned on incremental benefit.\n\nAction: Clarify premium differentiation', footer: '285 mentions • MIXED' },
            { id: 'feat-battery', type: 'card', colSpan: 1, icon: 'alert', title: 'Battery & Charging', content: 'Charging failures for premium models.\n\nAction: Investigate failure patterns', footer: '240 mentions • CONCERN' },
            { id: 'feat-app', type: 'card', colSpan: 1, icon: 'info', title: 'App Experience', content: 'Viewed as "nice extra" not essential.\n\nAction: Simplify onboarding; add tangible value', footer: '240 mentions • MIXED' },
            { id: 'feat-durability', type: 'card', colSpan: 1, icon: 'alert', title: 'Durability', content: 'Some report multiple replacements within 2 years.\n\nAction: Quality control review', footer: '180 mentions • CONCERN' },
            {
                id: 'priority-matrix', type: 'highlight-box', colSpan: 3, title: 'Action Priority Matrix',
                leftContent: { label: '🚨 CRITICAL - Immediate', tags: ['Brush head mold issue'] },
                rightContent: [
                    { value: '⚠️ HIGH - Address Soon', subtitle: 'Battery reliability, durability' },
                    { value: '📊 MEDIUM - Optimize', subtitle: 'Price perception, app experience' },
                    { value: '✅ STRENGTH - Amplify', subtitle: 'Cleaning performance messaging' }
                ]
            }
        ]
    },
    // Slide 6: Customer Voices - Strengths
    {
        ...
        elements: [
            ...
            { id: 'quote1', type: 'quote', colSpan: 1, icon: 'thumbsup', content: '"My teeth have never felt this clean. My dentist even noticed the difference at my last checkup."', footer: 'Amazon Review - iO 5' },
            { id: 'quote2', type: 'quote', colSpan: 1, icon: 'thumbsup', content: '"The pressure sensor is a game-changer. I was brushing way too hard before."', footer: 'Reddit - r/DentalHygiene - iO 9' },
            { id: 'quote3', type: 'quote', colSpan: 1, icon: 'thumbsup', content: '"Feels like I just left the dentist every time I brush. Worth every penny for the clean feeling."', footer: 'Superpharm Review - iO 3' },
            { id: 'quote4', type: 'quote', colSpan: 1, icon: 'star', content: '"I don\'t need all the bells and whistles. The iO 3 cleans just as well as my friend\'s iO 9 for half the price."', footer: 'Amazon Review - iO 3' },
            { id: 'quote5', type: 'quote', colSpan: 1, icon: 'star', content: '"The iO 5 hits the sweet spot - smart features that matter without paying for extras I won\'t use."', footer: 'Reddit - r/Toothbrushes - iO 5' },
            { id: 'quote6', type: 'quote', colSpan: 1, icon: 'star', content: '"Best investment in my dental health. The iO 3 delivers professional cleaning at a reasonable price."', footer: 'YouTube Comment - iO 3' }
        ]
    },
    // Slide 7: Customer Voices - Concerns
    {
        ...
        elements: [
            ...
            { id: 'nquote1', type: 'quote', colSpan: 1, icon: 'thumbsdown', content: '"The charging base stopped working after 8 months. For a $300+ toothbrush, this is unacceptable."', footer: 'Amazon Review - iO 9' },
            { id: 'nquote2', type: 'quote', colSpan: 1, icon: 'thumbsdown', content: '"Found mold growing inside the brush head. This is disgusting for something that goes in my mouth daily."', footer: 'Reddit - r/DentalHygiene - iO Series' },
            { id: 'nquote3', type: 'quote', colSpan: 1, icon: 'thumbsdown', content: '"Battery life degraded significantly after a year. Now it dies mid-brush. Very frustrating."', footer: 'Superpharm Review - iO 7' },
            { id: 'nquote4', type: 'quote', colSpan: 1, icon: 'alert', content: '"The iO 9 cleans well, but I honestly can\'t tell the difference from the iO 5. Wish I\'d saved the money."', footer: 'Reddit - r/Toothbrushes - iO 9' },
            { id: 'nquote5', type: 'quote', colSpan: 1, icon: 'alert', content: '"Replacement heads cost almost as much as a basic electric toothbrush. This adds up fast."', footer: 'Amazon Review - iO Series' },
            { id: 'nquote6', type: 'quote', colSpan: 1, icon: 'alert', content: '"The app is clunky and adds no real value. I paid extra for \'smart\' features I never use."', footer: 'YouTube Comment - iO 10' }
        ]
    },
...
const CanvasElement = ({ element, onUpdate, onDelete, isHovered, onHover }) => {
    ...
    return (
        ...
        >
            ...
            {element.type === 'model-card' && (
                <div className="bg-white rounded-xl p-4 border border-slate-200 h-full">
                    <div className="flex items-start justify-between mb-2">
                        <div>
                            <h3 className="text-slate-900 font-semibold text-lg">{element.name}</h3>
                            <p className="text-slate-400 text-sm">{element.price}</p>
                        </div>
                        <div className="flex items-center gap-1 bg-amber-50 px-2 py-1 rounded-lg">
                            <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
                            <span className="text-slate-700 font-medium text-sm">{element.rating}</span>
                        </div>
                    </div>
                    <div className="space-y-2 mt-4">
                        <div className="flex justify-between text-sm">
                            <span className="text-slate-500">Reviews:</span>
                            <span className="text-slate-700 font-medium">{element.reviews}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-slate-500">Positive Sentiment:</span>
                            <span className="text-slate-700 font-medium">{element.sentiment}%</span>
                        </div>
                        <div className="w-full bg-slate-100 rounded-full h-2 mt-1">
                            <div 
                                className="h-2 rounded-full transition-all"
                                style={{ 
                                    width: `${element.sentiment}%`,
                                    backgroundColor: element.sentiment >= 90 ? '#f97316' : element.sentiment >= 70 ? '#fb923c' : '#fdba74'
                                }}
                            />
                        </div>
                    </div>
