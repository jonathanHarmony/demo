        ...
        return (
          <div className="h-full p-6 flex flex-col" dir="rtl">
            ...
            <div className="flex gap-8 mb-6 h-[220px]">
              ...
              <div className="w-1/2">
                 <ResponsiveContainer width="100%" height="100%">
                   <BarChart data={curiosityChartData} layout="vertical" margin={{top: 0, right: 100, left: 20, bottom: 0}} barSize={35}>
                     <XAxis type="number" domain={[0, 55]} hide />
                     <YAxis 
                        dataKey="name" 
                        type="category" 
                        tick={{fontSize: 18, fontWeight: 'bold', fill: '#1A1A1A', dx: 10}} 
                        width={120} 
                        axisLine={false} 
                        tickLine={false} 
                        orientation="right"
                     />
                     <Bar dataKey="value" radius={[8, 0, 0, 8]} maxBarSize={200}>
                       <LabelList dataKey="value" position="left" fontSize={18} fontWeight="bold" fill="#1A1A1A" offset={10} />
