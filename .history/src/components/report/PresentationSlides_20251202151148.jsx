...
export default function PresentationSlides({ slideIndex }) {
  ...
  const renderSlide = () => {
    switch (slideIndex) {
      ...
      case 1:
        return (
          <div className="h-full p-16 flex flex-col bg-white" dir="rtl">
      ...
      case 13:
        ...
        return (
          <div className="h-full px-6 py-4 flex flex-col" dir="rtl">
            ...
            <div className="flex gap-6 mb-4 h-[180px]">
               {/* Remilk Box */}
          ...
          <div className="h-full flex overflow-hidden" dir="rtl">
             ...
             <div className="w-2/3 p-8 flex flex-col">
                ...
                <div className="flex flex-col gap-3 mb-6 flex-grow">
                 ...
                 {/* Brand Bars - MUCH MORE VISIBLE */}
                 <div className="mb-6">
                    <div className="flex justify-between text-sm font-bold text-gray-600 mb-2">
                       <span>Remilk (4)</span>
                       <span>Cowfree (1)</span>
                    </div>
                    <div className="h-12 w-full bg-gray-100 rounded-lg overflow-hidden flex shadow-inner">
                       <div className="h-full bg-[#0F1C2E] flex items-center justify-center text-white font-bold text-xl" style={{width: '80%'}}>4</div>
                       <div className="h-full bg-[#3CC4C7] flex items-center justify-center text-white font-bold text-xl" style={{width: '20%'}}>1</div>
                    </div>
                 </div>
