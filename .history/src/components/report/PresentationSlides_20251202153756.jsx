        ...
        return (
          <div className="h-full p-6 flex flex-col" dir="rtl">
            ...
            <div className="flex gap-8 mb-6 h-[220px]">
              ...
              <div className="w-1/2">
                 <ResponsiveContainer width="100%" height="100%">
                   <BarChart data={curiosityChartData} layout="vertical" margin={{top: 0, right: 100, left: 10, bottom: 0}} barSize={30}>
          ...
          <div className="h-full flex overflow-hidden" dir="rtl">
             ...
             <div className="w-2/3 p-8 flex flex-col">
                ...
                <div className="flex flex-col gap-3 mb-6 flex-grow">
                 ...
                 {/* Brand Bars - EXTREMELY VISIBLE */}
                 <div className="mb-6">
                    <div className="flex justify-between text-lg font-bold text-gray-800 mb-4">
                       <span>Remilk (4)</span>
                       <span>Cowfree (1)</span>
                    </div>
                    <div className="h-20 w-full bg-white rounded-xl overflow-hidden flex shadow-2xl border-4 border-gray-400">
                       <div className="h-full bg-[#0F1C2E] flex items-center justify-center text-white font-bold text-3xl" style={{width: '80%'}}>4</div>
                       <div className="h-full bg-[#3CC4C7] flex items-center justify-center text-white font-bold text-3xl" style={{width: '20%'}}>1</div>
                    </div>
                 </div>
