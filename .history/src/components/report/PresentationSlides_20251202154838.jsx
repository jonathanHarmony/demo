        ...
        return (
          <div className="h-full p-6 flex flex-col" dir="rtl">
            ...
            <div className="mb-6 bg-red-500 p-4">
              <h2 className="text-3xl font-bold text-white">❌ TEST - מנוע הסקרנות: התיאבון של Cowfree מול העניין של Remilk</h2>
            ...
            <div className="flex gap-8 mb-6 h-[220px]">
              ...
              <div className="w-1/2">
                 <ResponsiveContainer width="100%" height="100%">
                   <BarChart data={curiosityChartData} layout="vertical" margin={{top: 0, right: 150, left: 10, bottom: 0}} barSize={25}>
            ...
            <div className="flex-grow bg-gray-50 rounded-xl p-6 flex items-end justify-around pb-16">
               {flavorData.map((f, i) => (
                 <div key={i} className="flex flex-col items-center gap-3 group">
                    ...
                    <div className="w-20 bg-harmonyBlue rounded-t-lg transition-all duration-700 ease-out" style={{height: `${f.val * 20}px`}}></div>
