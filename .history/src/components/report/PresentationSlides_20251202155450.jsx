        ...
        return (
          <div className="h-full p-6 flex flex-col" dir="rtl">
            ...
            <div className="flex gap-8 mb-6 h-[220px]">
              ...
              <div className="w-1/2">
                 <ResponsiveContainer width="100%" height="100%">
                   <BarChart data={curiosityChartData} layout="vertical" margin={{top: 0, right: 200, left: 10, bottom: 0}} barSize={20}>
                     <XAxis type="number" domain={[0, 300]} hide />
                     <YAxis dataKey="name" type="category" tick={{fontSize: 16, fontWeight: 'bold', fill: '#1A1A1A'}} width={90} axisLine={false} tickLine={false} />
                     <Bar dataKey="value" radius={[0, 8, 8, 0]} maxBarSize={200}>
                       <LabelList dataKey="value" position="right" fontSize={16} fontWeight="bold" fill="#1A1A1A" offset={8} />
      ...
      case 15:
        ...
        return (
          <div className="h-full p-6 flex flex-col" dir="rtl">
            ...
            <div className="flex-grow bg-gray-50 rounded-xl p-8 flex flex-col justify-center gap-6">
               {flavorData.map((f, i) => (
                 <div key={i} className="flex items-center gap-4">
                    <div className="text-5xl">{f.icon}</div>
                    <div className="font-bold text-xl text-harmonyDark w-32">{f.name}</div>
                    <div className="flex-1 h-16 bg-harmonyBlue rounded-lg transition-all duration-700 ease-out" style={{width: `${f.val * 40}px`}}></div>
                    <div className="text-2xl text-harmonyDark font-bold w-12 text-center">{f.val}</div>
                 </div>
               ))}
            </div>
          ...
          <div className="h-full flex overflow-hidden" dir="rtl">
             ...
             <div className="w-2/3 p-8 flex flex-col">
                ...
                <div className="flex flex-col gap-3 mb-6 flex-grow">
                 ...
                 {/* Brand Bars - IMPOSSIBLE TO MISS */}
                 <div className="mb-8 bg-yellow-50 p-4 rounded-xl">
                    <div className="flex justify-between text-xl font-bold text-gray-900 mb-4">
                       <span className="bg-[#0F1C2E] text-white px-3 py-1 rounded">Remilk (4)</span>
                       <span className="bg-[#3CC4C7] text-white px-3 py-1 rounded">Cowfree (1)</span>
                    </div>
                    <div className="h-24 w-full bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl overflow-hidden flex shadow-2xl border-4 border-black">
                       <div className="h-full bg-[#0F1C2E] flex items-center justify-center text-white font-black text-4xl" style={{width: '80%'}}>4</div>
                       <div className="h-full bg-[#3CC4C7] flex items-center justify-center text-white font-black text-4xl" style={{width: '20%'}}>1</div>
                    </div>
                 </div>
