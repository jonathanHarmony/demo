                ...
                <div className="grid grid-cols-2 gap-4">
                    {element.features?.map((feat, i) => {
                        ...
                        return (
                            <div 
                                key={i} 
                                className={`bg-white rounded-xl p-4 border border-slate-200 border-l-4 ${getBorderColor(feat.statusColor)} ${feat.hasEvidence ? 'cursor-help relative' : ''}`}
                                onMouseEnter={() => feat.hasEvidence && setShowEvidence(true)}
                                onMouseLeave={() => feat.hasEvidence && setShowEvidence(false)}
                            >
