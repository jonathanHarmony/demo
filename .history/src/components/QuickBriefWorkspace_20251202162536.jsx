...
// --- Block Component ---
const Block = ({ block, onUpdate, onDelete, onTag, onAddSection, isHovered, onHover, onChangeChartType }) => {
            ...
            <div className="relative">
                ...
                {isHovered && (
                    <div className="absolute -right-10 top-1 flex items-center gap-1">
                        <button onClick={() => onAddSection(block.id)} className="p-1 hover:bg-slate-100 rounded text-slate-400 hover:text-indigo-600">
                            <Plus size={14} />
                        </button>
...
const QuickBriefWorkspace = () => {
    ...
    const [chatMessages, setChatMessages] = useState([
        { id: 1, sender: 'ai', text: 'Welcome to your notebook! I can help you analyze your data and generate insights.' }
    ]);
