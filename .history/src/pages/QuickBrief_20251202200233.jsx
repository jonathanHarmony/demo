...
import QuickBriefDemo from "@/components/QuickBriefDemo";

// Set to true to use demo mode
const USE_DEMO_MODE = true;

export default function QuickBriefWorkspace() {
  // Demo mode - return the demo component
  if (USE_DEMO_MODE) {
    return <QuickBriefDemo initialQuestion="What is the customer satisfaction for Oral-B iO models?" />;
  }
